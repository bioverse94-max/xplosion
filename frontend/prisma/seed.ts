...
async function main() {
  ...
  // 2. Seed Flagship Event (Clearly marked placeholder event)
  ...
  const rules = [
    ...
    "Dress Code: Club Glam / Cyber-Chic / Upscale Casual (No flip-flops or sportswear).",
  ...
  const faqs = [
    {
      ...
      answer: "Upon successful payment verification, an encrypted digital pass with a cryptographic QR code is generated instantly. You can view, download, or access it anytime via the /my-pass portal.",
    },
    {
    ...
    },
    {
      ...
      answer: "Visit the /my-pass page on this portal, enter your registered email or phone number, and you can instantly re-access your pass.",
    },
    {
  ...
  const event = await prisma.event.create({
    data: {
      ...
      venueName: "Club Hyperion & Skydeck [Placeholder Venue]",
